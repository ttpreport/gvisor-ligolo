...
import (
	...
	"github.com/ttpreport/gvisor-ligolo/pkg/memutil"
	...
	"github.com/ttpreport/gvisor-ligolo/pkg/sentry/loader"
	...
	"github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/netfilter"
	"github.com/ttpreport/gvisor-ligolo/pkg/sentry/time"
	...
	"github.com/ttpreport/gvisor-ligolo/pkg/tcpip/link/ethernet"
	"github.com/ttpreport/gvisor-ligolo/pkg/tcpip/link/loopback"
	"github.com/ttpreport/gvisor-ligolo/pkg/tcpip/link/packetsocket"
	"github.com/ttpreport/gvisor-ligolo/pkg/tcpip/link/sniffer"
	"github.com/ttpreport/gvisor-ligolo/pkg/tcpip/network/arp"
	...
	"github.com/ttpreport/gvisor-ligolo/runsc/boot/filter"
	_ "github.com/ttpreport/gvisor-ligolo/runsc/boot/platforms" // register all platforms.
	pf "github.com/ttpreport/gvisor-ligolo/runsc/boot/portforward"
	"github.com/ttpreport/gvisor-ligolo/runsc/boot/pprof"
	"github.com/ttpreport/gvisor-ligolo/runsc/config"
	"github.com/ttpreport/gvisor-ligolo/runsc/profile"
	"github.com/ttpreport/gvisor-ligolo/runsc/specutils"
	"github.com/ttpreport/gvisor-ligolo/runsc/specutils/seccomp"
	"golang.org/x/sys/unix"

	// Top-level inet providers.
	"github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/hostinet"
	"github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/netstack"

	// Include other supported socket providers.
	_ "github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/netlink"
	_ "github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/netlink/route"
	_ "github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/netlink/uevent"
	_ "github.com/ttpreport/gvisor-ligolo/pkg/sentry/socket/unix"
)
